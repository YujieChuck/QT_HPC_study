    ...
    displayTime(displayTime)
{
    ...
    int intDefaultCycleNum=3;
    setCycleNum(intDefaultCycleNum);
    m_CycleCount = 1;
}
...
void Notify::setCycleNum(int &value)
{
    m_Cycle = value;
}
...
void Notify::hideGriant()
{
    ...
    connect(animation, &QPropertyAnimation::finished, this, [animation, this](){
        ...
        //Edit By Yujie in 05/07/2018
        int intHideTime = displayTime/2;
        QTimer::singleShot(intHideTime, this, [this](){
            if(m_CycleCount<=m_Cycle){
                m_CycleCount++;
                this->showGriant();
            }
            else{
